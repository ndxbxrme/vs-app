...
(function() {
  'use strict';
  angular.module('vs-agency').controller('agencyCaseCtrl', function($scope, $stateParams, $state, $timeout, $window, $http, Auth, progressionPopup, agencyProperty, Upload, env, alert) {
    $scope.propsOpts = {
      where: {
