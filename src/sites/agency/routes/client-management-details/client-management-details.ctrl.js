...
(function() {
  'use strict';
  angular.module('vs-agency').controller('agencyClientManagementDetailsCtrl', function($scope, $stateParams, $state, $timeout, $window, Auth, AgencyProgressionPopup, agencyProperty, Upload, env, alert) {
