...
(function() {
  'use strict';
  angular.module('vs-lettings-inner').directive('lettingsMilestone', function($rootScope, progressionPopup) {
    return {
      restrict: 'AE',
      ...
      link: function(scope, elem, attrs) {
        ...
        return scope.itemClick = function() {
          ...
          if (scope.disabled !== 'true') {
            ...
            return progressionPopup.show(elem[0], scope.milestone, property);
          }
        };
      }
    };
