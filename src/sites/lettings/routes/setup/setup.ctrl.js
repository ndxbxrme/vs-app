...
(function() {
  'use strict';
  angular.module('vs-lettings-inner').controller('lettingsSetupCtrl', function($scope, $http, $filter, $timeout, progressionPopup, alert) {
    var saveDashboard;
    $scope.editor = true;
    $scope.newUser = {
      role: 'agency'
    ...
    $scope.progressions = $scope.list('lettings:progressions', {
      ...
      return progressionPopup.setProgressions(progressions.items);
    });
