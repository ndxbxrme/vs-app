...
(function() {
  'use strict';
  angular.module('vs-lettings-inner').controller('lettingsCaseCtrl', function($scope, $stateParams, $state, $timeout, $window, $http, Auth, progressionPopup, lettingsProperty, Upload, env, alert, breadcrumbs) {
    $scope.propsOpts = {
      where: {
